        ...
        <div class="mb-4">
                <div class="row justify-content-end">
                    <div class="col-4 text-end">
                        <form id="formUsulan" action="{{route('forminput-store')}}" method="POST" onsubmit="return confirm('Apakah anda yakin akan menambahkan form usulan?');">
                            @csrf
                            <button type="submit" class="btn btn-primary">Buat Usulan Baru</button>
                        </form>
                    </div>
                    <div class="col-8">
            ...
            <table class="table border customize-table mb-3 align-middle">
                <thead class="text-dark fs-4">
                    <tr>
                        ...
                        <th>
                            <h6 class="fs-4 fw-semibold mb-0">Jenis Permohonan</h6>
                        </th>
                        <th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="mb-0">
                            ...
                            <small class="form-text text-muted d-block mb-0">{{ $row->nip }}</small>
                        </td>
                        <td class="mb-0">
                            <span class="badge {{ $row->form_input_id_before ? 'bg-primary' : 'bg-success' }}"> {{ $row->form_input_id_before ? 'Perpanjang' : 'Baru' }} </span>
                        </td>
                        <td class="mb-0">
                        ...
                        <td>
                            ...
                            <div class="dropdown dropstart">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('forminput-resume',['uniqid' => $row->uniq_id]) }}"><i class="fs-4 ti ti-reload"></i>Reset</a>
                                    </li>
                                    @endif
                                    @if($row->status == 'success')
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('forminput-export',['uniqid' => $row->uniq_id]) }}"><i class="fs-4 ti ti-printer"></i>Download Surat Keterangan</a>
                                    </li>
                                    @endif
                                </ul>
                            </div>
