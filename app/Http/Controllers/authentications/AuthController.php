...
class AuthController extends Controller
{
    ...
    public function dologin(Request $request)
    {
        ...
        if(!Auth::user()->hasRole('admin') && !Auth::user()->hasRole('member') && !Auth::user()->hasRole('exmember')){ //disabled login teacher
            Auth::guard('web')->logout();
            $request->session()->invalidate();
            $request->session()->regenerateToken();

            return redirect()->route('auth')->withErrors(['msg' => 'Akun tidak mendapat izin! Silahkan hubungi admin.']);
        }
        ...
        if(Auth::user()->hasRole('member')){
            return redirect()->route('forminput-index');
        }
    ...
    public function storeRegister(Request $request)
    {
        ...
        return jsend_success(['message' => 'Registrasi berhasil silahkan hubungi admin untuk aktivasi akun.']);
    }
